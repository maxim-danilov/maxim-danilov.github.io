...
## My current .vimrc
You can find the latest version of my .vimrc in my repository: [https://github.com/maxim-danilov/vim-config-maxim-danilov](https://github.com/maxim-danilov/vim-config-maxim-danilov)
